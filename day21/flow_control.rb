...
class FlowControl
  ...
  attr_reader :instruction_pointer, :instructions, :registers, :instruction_count

  def initialize(instruction_string, starting_registers)
  ...
  def perform_instructions
    while pointer_in_program? && instruction_count < 100_000
